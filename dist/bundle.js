...
function ModelNameToModel(name) {
    switch (name) {
        case "Band":
            return Band_1.default;
        case "Conversation":
            return Conversation_1.default;
        case "ErrorReport":
            return ErrorReport_1.default;
        case "FacebookAccount":
            return FacebookAccount_1.default;
        case "Gig":
            return Gig_1.default;
        case "GooglePlace":
            return GooglePlace_1.default;
        case "Location":
        ...
        case "Post":
            return Post_1.default;
        case "Request":
            return Request_1.default;
        case "TwitterAccount":
            return TwitterAccount_1.default;
        case "Upload":
            return Upload_1.default;
        case "User":
            return User_1.default;
        case "Venue":
            return Venue_1.default;
        default:
            return null;
    }
}
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (typeof Model === "string")
                            Model = index_1.ModelNameToModel(ModelMaybe);
                ...
                var Return_1 = function (results) {
                    ...
                    query.forEach(function (item) {
                        if (item && item.ModelName) {
                            ...
                            var ClassType = index_1.ModelNameToModel(mName);
                            if (ClassType) {
