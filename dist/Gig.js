...
var Gig = function (_RESTModel) {
  ...
  (0, _createClass3.default)(Gig, [{
    ...
    value: function getBands(token) {
      return _Band2.default.findMany({ _id: this.bands }, token);
    }
  }, {
    key: "getVenue",
    ...
    get: function get() {
      ...
      return startTime ? (0, _moment2.default)(startTime) : startTime;
    },
    ...
    get: function get() {
      ...
      return stopTime ? (0, _moment2.default)(stopTime) : stopTime;
    },
    set: function set(value) {
    ...
    value: function findById(id, token) {
      return _RESTModel3.default.findById(Gig, id, token, true);
    }
  }, {
    key: "findByBand",
    value: function () {
    ...
    value: function getAllOwned(token) {
      return _RESTModel3.default.findMany(Gig, null, token, true);
    }
  }, {
    key: "findMany",
    value: function findMany(criteria, token) {
      return _RESTModel3.default.findMany(Gig, criteria, token, true);
    }
  }, {
    key: "createGigs",
