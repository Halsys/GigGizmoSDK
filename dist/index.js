...
var SocketIO = __importStar(__webpack_require__(/*! socket.io-client */ "socket.io-client"));
var API = /** @class */ (function () {
    ...
    Object.defineProperty(API, "expires", {
        get: function () {
            if (!API._expires && API.LocalStorageSupported) {
                var expires = localStorage.getItem("expires") || null;
    ...
    API.getSocket = function () {
        return __awaiter(this, void 0, void 0, function () {
            var killSocket, onReady, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        killSocket = function (error) {
                            if (error) {
                                console.error(error);
                            }
                            if (API.webSocket) {
                        ...
                        if (!API.WebSocket) return [3 /*break*/, 7];
                        if (!(typeof document !== "undefined")) return [3 /*break*/, 6];
                        _a = document.readyState;
                        switch (_a) {
                            case "loading": return [3 /*break*/, 1];
                            case "interactive": return [3 /*break*/, 3];
                            case "complete": return [3 /*break*/, 3];
                        }
                        return [3 /*break*/, 4];
                    ...
                    case 2:
                        _b.sent();
                        return [2 /*return*/, onReady()];
                    case 3: return [2 /*return*/, onReady()];
                    case 4: throw new Error("Unexpected readyState: " + document.readyState);
                    case 5: return [3 /*break*/, 7];
                    case 6: return [2 /*return*/, onReady()];
...
Object.defineProperty(exports, "__esModule", { value: true });
var FacebookAccount_1 = __importDefault(__webpack_require__(/*! ./FacebookAccount */ "./src/FacebookAccount.ts"));
var Gig_1 = __importDefault(__webpack_require__(/*! ./Gig */ "./src/Gig.ts"));
var RESTModel_1 = __importDefault(__webpack_require__(/*! ./RESTModel */ "./src/RESTModel.ts"));
var TwitterAccount_1 = __importDefault(__webpack_require__(/*! ./TwitterAccount */ "./src/TwitterAccount.ts"));
var Upload_1 = __importDefault(__webpack_require__(/*! ./Upload */ "./src/Upload.ts"));
var User_1 = __importDefault(__webpack_require__(/*! ./User */ "./src/User.ts"));
...
Object.defineProperty(exports, "__esModule", { value: true });
var API_1 = __importDefault(__webpack_require__(/*! ./API */ "./src/API.ts"));
var RESTModel_1 = __importDefault(__webpack_require__(/*! ./RESTModel */ "./src/RESTModel.ts"));
var Conversation = /** @class */ (function (_super) {
        ...
        API_1.default.getSocket().then(function (socket) {
            if (socket) {
                socket.on("/API/Conversation/Update", function (data) {
                    if (data) {
                        var conv_1 = RESTModel_1.default.CacheGet(data._id);
                        if (conv_1) {
    ...
    Conversation.findOne = function (criteria) {
        return RESTModel_1.default.findOneBase(Conversation, criteria);
    };
    Conversation.findMany = function (criteria) {
        return RESTModel_1.default.findManyBase(Conversation, criteria, false);
    };
...
var ErrorReport = /** @class */ (function (_super) {
    ...
    ErrorReport.findOne = function (criteria) {
        return RESTModel_1.default.findOneBase(ErrorReport, criteria);
    };
...
var FacebookAccount = /** @class */ (function (_super) {
    ...
    FacebookAccount.findOne = function (criteria) {
        return RESTModel_1.default.findOneBase(FacebookAccount, criteria, true);
    };
    FacebookAccount.findMany = function (criteria) {
        return RESTModel_1.default.findManyBase(FacebookAccount, criteria, true);
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var API_1 = __importDefault(__webpack_require__(/*! ./API */ "./src/API.ts"));
var Band_1 = __importDefault(__webpack_require__(/*! ./Band */ "./src/Band.ts"));
var Location_1 = __importDefault(__webpack_require__(/*! ./Location */ "./src/Location.ts"));
var RESTModel_1 = __importDefault(__webpack_require__(/*! ./RESTModel */ "./src/RESTModel.ts"));
var Venue_1 = __importDefault(__webpack_require__(/*! ./Venue */ "./src/Venue.ts"));
...
var GooglePlace = /** @class */ (function (_super) {
    ...
    GooglePlace.findById = function (id) {
        return RESTModel_1.default.findByIdBase(GooglePlace, id);
    };
    GooglePlace.findOne = function (criteria) {
        return RESTModel_1.default.findOneBase(GooglePlace, criteria);
    };
    GooglePlace.findMany = function (criteria) {
        return RESTModel_1.default.findManyBase(GooglePlace, criteria, false);
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var API_1 = __importDefault(__webpack_require__(/*! ./API */ "./src/API.ts"));
var GooglePlace_1 = __importDefault(__webpack_require__(/*! ./GooglePlace */ "./src/GooglePlace.ts"));
var RESTModel_1 = __importDefault(__webpack_require__(/*! ./RESTModel */ "./src/RESTModel.ts"));
var Location = /** @class */ (function (_super) {
    ...
    Location.findOne = function (criteria) {
        return RESTModel_1.default.findOneBase(Location, criteria);
    };
    Location.findMany = function (criteria) {
        return RESTModel_1.default.findManyBase(Location, criteria, false);
    };
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [3 /*break*/, 31];
                case 1: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(__webpack_require__(/*! ./Band */ "./src/Band.ts")); })];
                case 2: return [2 /*return*/, (_b.sent()).default];
                case 3: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(__webpack_require__(/*! ./Conversation */ "./src/Conversation.ts")); })];
                case 4: return [2 /*return*/, (_b.sent()).default];
                case 5: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(__webpack_require__(/*! ./ErrorReport */ "./src/ErrorReport.ts")); })];
                case 6: return [2 /*return*/, (_b.sent()).default];
                case 7: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(__webpack_require__(/*! ./FacebookAccount */ "./src/FacebookAccount.ts")); })];
                case 8: return [2 /*return*/, (_b.sent()).default];
                case 9: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(__webpack_require__(/*! ./Gig */ "./src/Gig.ts")); })];
                case 10: return [2 /*return*/, (_b.sent()).default];
                case 11: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(__webpack_require__(/*! ./GooglePlace */ "./src/GooglePlace.ts")); })];
                case 12: return [2 /*return*/, (_b.sent()).default];
                case 13: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(__webpack_require__(/*! ./Location */ "./src/Location.ts")); })];
                case 14: return [2 /*return*/, (_b.sent()).default];
                case 15: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(__webpack_require__(/*! ./Notification */ "./src/Notification.ts")); })];
                case 16: return [2 /*return*/, (_b.sent()).default];
                case 17: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(__webpack_require__(/*! ./Page */ "./src/Page.ts")); })];
                case 18: return [2 /*return*/, (_b.sent()).default];
                case 19: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(__webpack_require__(/*! ./Post */ "./src/Post.ts")); })];
                case 20: return [2 /*return*/, (_b.sent()).default];
                case 21: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(__webpack_require__(/*! ./Request */ "./src/Request.ts")); })];
                case 22: return [2 /*return*/, (_b.sent()).default];
                case 23: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(__webpack_require__(/*! ./TwitterAccount */ "./src/TwitterAccount.ts")); })];
                case 24: return [2 /*return*/, (_b.sent()).default];
                case 25: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(__webpack_require__(/*! ./Upload */ "./src/Upload.ts")); })];
                case 26: return [2 /*return*/, (_b.sent()).default];
                case 27: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(__webpack_require__(/*! ./User */ "./src/User.ts")); })];
                case 28: return [2 /*return*/, (_b.sent()).default];
                case 29: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(__webpack_require__(/*! ./Venue */ "./src/Venue.ts")); })];
...
var Notification = /** @class */ (function (_super) {
    ...
    Notification.prototype.newChangeCallback = function (callback) {
        ...
        return function () { _this.changeCallbacks.delete(i); };
    };
...
var Post = /** @class */ (function (_super) {
    ...
    Post.findOne = function (criteria) {
        return RESTModel_1.default.findOneBase(Post, criteria);
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var Band_1 = __importDefault(__webpack_require__(/*! ./Band */ "./src/PropTypes/Band.ts"));
var Conversation_1 = __importDefault(__webpack_require__(/*! ./Conversation */ "./src/PropTypes/Conversation.ts"));
var ErrorReport_1 = __importDefault(__webpack_require__(/*! ./ErrorReport */ "./src/PropTypes/ErrorReport.ts"));
var FacebookAccount_1 = __importDefault(__webpack_require__(/*! ./FacebookAccount */ "./src/PropTypes/FacebookAccount.ts"));
var Gig_1 = __importDefault(__webpack_require__(/*! ./Gig */ "./src/PropTypes/Gig.ts"));
var Location_1 = __importDefault(__webpack_require__(/*! ./Location */ "./src/PropTypes/Location.ts"));
var Notification_1 = __importDefault(__webpack_require__(/*! ./Notification */ "./src/PropTypes/Notification.ts"));
var Page_1 = __importDefault(__webpack_require__(/*! ./Page */ "./src/PropTypes/Page.ts"));
var Post_1 = __importDefault(__webpack_require__(/*! ./Post */ "./src/PropTypes/Post.ts"));
var TwitterAccount_1 = __importDefault(__webpack_require__(/*! ./TwitterAccount */ "./src/PropTypes/TwitterAccount.ts"));
var Upload_1 = __importDefault(__webpack_require__(/*! ./Upload */ "./src/PropTypes/Upload.ts"));
var User_1 = __importDefault(__webpack_require__(/*! ./User */ "./src/PropTypes/User.ts"));
var Venue_1 = __importDefault(__webpack_require__(/*! ./Venue */ "./src/PropTypes/Venue.ts"));
exports.default = {
    Band: Band_1.default,
...
Object.defineProperty(exports, "__esModule", { value: true });
var API_1 = __importDefault(__webpack_require__(/*! ./API */ "./src/API.ts"));
var ModelNameToModel_1 = __importDefault(__webpack_require__(/*! ./ModelNameToModel */ "./src/ModelNameToModel.ts"));
var RESTModel = /** @class */ (function () {
    ...
    RESTModel.CacheGet = function (id) {
    ...
    RESTModel.CacheSet = function (data) {
    ...
    RESTModel.CacheRemove = function (id) {
                    ...
                    case 0:
                        ...
                        if (Array.from(Object.keys(criteria)).length === 1 && Array.isArray((criteria._id || criteria.id))) {
                            ...
                            (criteria._id || criteria.id).forEach(function (id) {
                                var cache = RESTModel.CacheGet(id);
                                if (cache) {
                                    items_1.push(cache);
                                }
                            });
...
var TwitterAccount = /** @class */ (function (_super) {
    ...
    TwitterAccount.findOne = function (criteria) {
        return RESTModel_1.default.findOneBase(TwitterAccount, criteria, true);
    };
    TwitterAccount.findMany = function (criteria) {
        return RESTModel_1.default.findManyBase(TwitterAccount, criteria, true);
    };
...
var Upload = /** @class */ (function (_super) {
    ...
    Upload.findOne = function (criteria) {
        return RESTModel_1.default.findOneBase(Upload, criteria);
    };
...
var API_1 = __importDefault(__webpack_require__(/*! ./API */ "./src/API.ts"));
var Band_1 = __importDefault(__webpack_require__(/*! ./Band */ "./src/Band.ts"));
var Conversation_1 = __importDefault(__webpack_require__(/*! ./Conversation */ "./src/Conversation.ts"));
var FacebookAccount_1 = __importDefault(__webpack_require__(/*! ./FacebookAccount */ "./src/FacebookAccount.ts"));
var Gig_1 = __importDefault(__webpack_require__(/*! ./Gig */ "./src/Gig.ts"));
var Location_1 = __importDefault(__webpack_require__(/*! ./Location */ "./src/Location.ts"));
var Notification_1 = __importDefault(__webpack_require__(/*! ./Notification */ "./src/Notification.ts"));
var Page_1 = __importDefault(__webpack_require__(/*! ./Page */ "./src/Page.ts"));
var Post_1 = __importDefault(__webpack_require__(/*! ./Post */ "./src/Post.ts"));
var RESTModel_1 = __importDefault(__webpack_require__(/*! ./RESTModel */ "./src/RESTModel.ts"));
var TwitterAccount_1 = __importDefault(__webpack_require__(/*! ./TwitterAccount */ "./src/TwitterAccount.ts"));
var Upload_1 = __importDefault(__webpack_require__(/*! ./Upload */ "./src/Upload.ts"));
var Venue_1 = __importDefault(__webpack_require__(/*! ./Venue */ "./src/Venue.ts"));
var User = /** @class */ (function (_super) {
    ...
    User.getAllNotifications = function () {
        return RESTModel_1.default.findManyBase(Notification_1.default, null, true);
    };
